...
//        
//        //有连接请求完成，判断
//        NSLog(@"********* loadingReqNum = %ld, curRequestArr.count = %ld", weakSelf.loadingReqNum, self.requestArr.count);
...
//        
//        
//        NSLog(@"第一次请求_________  requestArr.count: %ld", self.requestArr.count);
//        [self printRequest];
//        return;
// 
//    }
...
//        
//        //NSLog(@"当前没有请求_________  requestArr.count: %ld", self.requestArr.count);
//        [self printRequest];
//        return;
//        
//    }
...
//        
//        
//        NSLog(@"往后拖_________  requestArr.count: %ld", self.requestArr.count);
//        [self printRequest];
//
//        
//    } else if (isForward) {
...
//        [self makeRequestFromBlockArr:blockArr];
//        
//        NSLog(@"往前拖_________  requestArr.count: %ld", self.requestArr.count);
//        [self printRequest];
//        
//        
//    } else {
