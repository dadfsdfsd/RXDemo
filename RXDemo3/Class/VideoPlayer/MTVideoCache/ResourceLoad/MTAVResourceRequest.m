...
//        dispatch_async([[WMCacher sharedInstance] queue ], ^{
...
//                char *zeroPoint = malloc(len);
//                memset(zeroPoint, 0, len);
//                
//                //写入缓存文件
//                NSMutableData *data = [[NSMutableData alloc] initWithBytes:zeroPoint length:len];
//                
...
//            
//            flag = YES;
//            NSInteger segment = self.curSegmentOffset / segLen;
...
//        
//        //打印segmentSet的当前元素个数
//        NSLog(@"____segmentSet.curCount = %ld", [self.curResourceInfo.segmentSet count]);
//        
//        
//        //通知loaderManager
...
//        
//        NSInteger segment = self.curOffset / [MTAVResourceInfo segmentLength];
//        [self.curResourceInfo.segmentSet removeObject:@(segment)];
//    }
//    
//    
...
//    
//    
//    NSLog(@"response________: curOffset = %lld, len = %ld", self.curOffset, self.cacheData.length);
//    
//    
...
//
//
//- (void)sendRequestWithOffset:(long long)offset Length:(long long)len
//{
//    
//    //创建下载请求，超时值15s
